...
export default function PedicuresManicuresPage() {
    ...
    <main className="max-w-4xl mx-auto px-6 py-20">
      ...
      >
        <Button
          ...
          onClick={() => router.push("/appointment?service=Pedicures/Manicures")}
        >
          Book Pedicures/Manicures
        </Button>
      </motion.div>

      <h1 className="text-4xl font-bold mt-4">Pedicures/Manicures</h1>
      ...
      <div className="mt-6">
        <img
          ...
          alt="Pedicures and manicures setup"
      ...
      <section className="mt-6">
        ...
        <p className="mt-2">
          This session includes nail shaping, cuticle care, and a relaxing finish for both hands and feet.
          It is ideal when you want polished results and self-care in one visit.
        </p>
      </section>
